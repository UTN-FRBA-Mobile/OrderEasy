...
@Composable
fun RequestTicket(navCont: NavController,userViewModel: UserViewModel) {
    Scaffold (
                ...
                verticalArrangement = Arrangement.Top
                   ...
                   ExtendedFloatingActionButton(
                        modifier = Modifier
                            .fillMaxWidth()
                            .padding(14.dp),
                        onClick = { navCont.navigate(route="IndividualTicket")},
                    ...
                    ExtendedFloatingActionButton(
                        modifier = Modifier
                            .fillMaxWidth()
                            .padding(14.dp),
                        onClick = { navCont.navigate(route="DivideTicket")},
                    ...
                    ExtendedFloatingActionButton(
                        modifier = Modifier
                            .fillMaxWidth()
                            .padding(14.dp),
                        onClick = { navCont.navigate(route = "InviteTicket") },
